...
namespace CodingCraftHOMod1Ex3Modularizacao.Mvc.Comum.Controllers
{
    ...
    public class PublicarController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.FuncionarioId = new SelectList(db.Users, "FuncionarioId", "Nome");
            return View();
        }
        ...
        [HttpPost]
        public async Task<ActionResult> ConcluirPublicacao(int id)
        {
            var texto = new Texto
            {
                TextoId = id,
            ...
            {
                db.Textos.Attach(texto);
                db.Entry(texto).Property(x => x.Publicado).IsModified = true;
