...
namespace CodingCraftHOMod1Ex3Modularizacao.Mvc.Comum.Controllers
{
    ...
    public class RevisaoController : Controller
    {
        ...
        public async Task<ActionResult> Edit(int? id)
        {
            ...
            ViewBag.CursoId = new SelectList(db.Cursos, "CursoId", "Nome", texto.CursoId);
            //ViewBag.FuncionarioId = new SelectList(dbFuncionarios, "FuncionarioId", "Nome", texto.FuncionarioId);
            return View(texto);
        }
        ...
        [HttpPost]
        public async Task<ActionResult> ConcluirRevisao(int id)
        {
            var texto = new Texto {
                TextoId = id,
                Revisado = true
            ...
            {
                db.Textos.Attach(texto);
                db.Entry(texto).Property(x => x.Revisado).IsModified = true;
