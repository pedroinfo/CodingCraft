...
using CodingCraftHOMod1Ex4Identity.ViewModels;
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetPasswordSuccess ? "Sua senha foi configurada."
                : message == ManageMessageId.SetTwoFactorSuccess ? "Sua autenticação em dois passos foi configurada."
